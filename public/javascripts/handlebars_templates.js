...
this["JST"]["user/login"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h1>Log in</h1><form action=\"/users/login\" method=\"post\"><fieldset><dl><dt><label for=\"email\">Email</label></dt><dd><input id=\"username\" type=\"text\" name=\"email\" placeholder=\"Email\"></dd><dt><label for=\"password\">Password</label></dt><dd><input id=\"password\" type=\"text\" name=\"password\" placeholder=\"Password\"></dd></dl></fieldset><fieldset class=\"actions\"><a href=\"/users/login\" class=\"button\" id=\"login\">Login</a><a href=\"/\" class=\"button\" id=\"cancel\">Cancel</a></fieldset><h3>Have no account?</h3><fieldset class=\"actions\"><a href=\"/users/signup\" class=\"button\" id=\"signup\">Sign Up</a> </fieldset></form>";
},"useData":true});

this["JST"]["user/signup"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h1>Sign Up</h1><form action=\"/users/signup\" method=\"post\"><fieldset><dl><dt><label for=\"email\">Email</label></dt><dd><input id=\"email\" type=\"text\" name=\"email\" placeholder=\"Email\"></dd><dt><label for=\"password\">Password</label></dt><dd><input id=\"password\" type=\"text\" name=\"password\" placeholder=\"Password\"></dd></dl></fieldset><fieldset class=\"actions\"><a href=\"/users/signup\" class=\"button\" id=\"signup\">Sign Up</a><a href=\"/\" class=\"button\" id=\"cancel\">Cancel</a></fieldset><h3>Already have an account?</h3><fieldset class=\"actions\"><a href=\"/users/login\" class=\"button\" id=\"login\">Login</a> </fieldset></form>";
},"useData":true});